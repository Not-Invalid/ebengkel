                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mt-3 car-card">
                    <a href="{{ route('usedcar.detail', $car->id_mobil) }}" class="card-event p-3">
                      @if ($car->fotos && $car->fotos->file_foto_mobil_1)
                        <img src="{{ url($car->fotos->file_foto_mobil_1) }}" alt="Car Image" class="card-img-top">
                      @else
                        <img src="{{ asset('assets/images/components/image.png') }}" alt="Car Image" class="card-img-top">
                      @endif
                      <div class="card-body text-start">
                        ...
                        <div class="footer-card">
                          <div class="price d-flex justify-content-start">
                            <span class="price">Rp{{ number_format($car->harga_mobil, 0, ',', '.') }}</span>
                          </div>
                        </div>
                      </div>
                    </a>
              ...
              <nav aria-label="Page navigation">
                <ul class="pagination">
                  ...
                  @if ($mobilList->hasMorePages())
                    <li class="page-item">
                      <a href="{{ $mobilList->nextPageUrl() }}" class="page-link">{{ __('messages.usedcar.next') }}</a>
                    </li>
                  @else
                    <li class="page-item disabled">

...
@section('content')
  ...
  <div class="container daftar">
    <div class="wrapper">
      ...
      <form action="{{ route('store.pesanan-services', ['id_bengkel' => $id_bengkel, 'id_services' => $id_services]) }}"
        method="POST">
        @csrf
        <div class="input-box">
        ...
        <div class="input-box">
          <input type="text" id="telp_pelanggan" name="telp_pelanggan" placeholder="Masukkan nomor telepon Anda"
            required oninput="validatePhoneNumber(this)" maxlength="15">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          <input type="text" id="total" name="total"
            value="Rp {{ isset($service) ? number_format($service->harga_services, 0, ',', '.') : '' }}" required>
        </div>
        <!-- Remove the redundant 'nama_services' field -->

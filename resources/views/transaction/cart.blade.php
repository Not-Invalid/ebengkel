...
@section('content')
                ...
                <div class="col-lg-8 col-md-12">
                    @foreach ($cartItems as $item)
                        <div class="cart-item d-flex align-items-center mb-3 p-3" data-id="{{ $item->id }}"
                            ...
                            <div class="cart-item-image me-3">
                                <div class="cart-item-image flex-shrink-0 me-3">
                                    ...
                                    @elseif ($item->sparepart && $item->sparepart->fotoSparepart)
                                        <img src="{{ $item->sparepart->fotoSparepart->file_foto_spare_part_1 }}"
                                            class="rounded" alt="{{ $item->sparepart->nama_spare_part }}"
                                            style="width: 100px; height: 100px; object-fit: cover;">
                                    @else
                                        <img src="{{ asset('assets/images/components/image.png') }}" class="rounded"
                                            alt="Default Image" style="width: 100px; height: 100px; object-fit: cover;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <button class="btn btn-lg text-danger remove-item p-1" data-id="{{ $item->id }}"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="modalOrderForm" action="{{ route('cart.place-order') }}" method="POST">
                        ...
                        <input type="hidden" name="selected_items" id="hiddenSelectedItems"> <!-- New hidden input -->
    ...
    <script>
        ...
        function updatePriceDetails() {
            ...
            document.getElementById('hiddenSelectedItems').value = JSON.stringify(selectedItemIds);

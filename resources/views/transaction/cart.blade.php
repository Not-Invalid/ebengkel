        ...
        <div class="cart-summary p-3">
                    ...
                    @foreach ($shippingAddress as $address)
                        <li>
                            <a class="dropdown-item shipping"
                                onclick="updateAddress('{{ $address->nama_penerima }}', '{{ $address->lokasi_alamat_pengiriman }}', '{{ $address->telp_penerima }}')">
          ...
          <div class="dropdown border">
            ...
            <ul class="dropdown-menu w-100" aria-labelledby="shippingOptionsDropdown" style="z-index: 1050;">
              <li>
                <a class="dropdown-item shipping" data-shipping="Reguler" data-price="Rp 11.000" data-courier="J&T Express"
                  data-time="2-4 Hari" onclick="updateShipping('Reguler', 11000, 'J&T Express', '2-4 Hari')">
                  Reguler (Rp 11.000) - J&T Express
                </a>
              </li>
              <li>
                <a class="dropdown-item shipping" data-shipping="Ekspres" data-price="Rp 25.000" data-courier="Gojek Xpress"
                  data-time="1-2 Hari" onclick="updateShipping('Ekspres', 25000, 'Gojek Xpress', '1-2 Hari')">
                  Ekspres (Rp 25.000) - Gojek Xpress
                </a>
              </li>
              <li>
                <a class="dropdown-item shipping" data-shipping="Same Day" data-price="Rp 50.000" data-courier="JNE Super Speed"

...
@section('content')
  <!-- In the <section> and .container, ensure responsiveness for the layout -->
  ...
  <div class="container my-5">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12">
        @if ($cartItems->isEmpty())
          <div class="d-flex justify-content-center pb-5">
            <div class="empty-cart-message text-center col-lg-12"
              ...
              <a href="{{ route('ProductSparePart') }}" class="btn btn-primary mt-2"><i class="fas fa-cart-shopping"></i>
                Shop
                Now</a>
            </div>
          </div>
      ...
      <!-- Price Summary Column -->
      <div class="col-lg-4 mb-5 col-md-12">

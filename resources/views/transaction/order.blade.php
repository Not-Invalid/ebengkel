                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="checkout-section">
                                    ...
                                    <div class="mb-3">
                                        <label for="shippingAddress" class="form-label">Pilih Alamat Pengiriman</label>
                                        <select class="form-select" id="shippingAddress">
                                            <option value="">-- Pilih Alamat --</option>
                                            @foreach ($address as $address)
                                                <option value="{{ $address->id_alamat_pengiriman }}">
                                                    <span> {{ $address->nama_penerima }} - {{ $address->telp_penerima }},</span>
                                                    <small>{{ $address->lokasi_alamat_pengiriman }}</small>
                                                    <small>{{ $address->kota }}, {{ $address->provinsi }}</small>
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>

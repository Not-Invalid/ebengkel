...
<div class="container-xl">
    <img src="{{ $blog->foto_cover ? asset($blog->foto_cover) : asset('assets/images/components/image.png') }}" class="article-image mt-3" />
...
<div class="author-info d-flex">
    <div class="author mx-3">{{ $blog->penulis ?? 'Anonymous' }}</div>
    <div class="">{{ \Carbon\Carbon::parse($blog->tanggal_post)->format('F j, Y') }}</div>
</div>
    ...
    <article class="shadow">
        <a href="{{ route('blog.show', 1) }}">
            <div class="article-wrapper">
                <figure>
                    <img src="https://www.specialoffers.jcb/id/tips/japan/shutterstock_10.jpg" alt="Sushi and sashimi" />
                </figure>

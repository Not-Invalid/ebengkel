        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h4 class="title-header">{{ __('messages.workshop.see_our') }}</h4>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <form method="GET" action="" style="width: 60%;">
                            <div class="input-group">
                                <input type="text" name="search" value="{{ request('search') }}" required
                                    maxlength="255" placeholder="{{ __('messages.workshop.search') }}..."
                        ...
                        <div class="d-flex justify-content-center pb-5">
                            <div class="text-center">
                                <img src="{{ asset('assets/images/components/empty.png') }}" height="200" width="200"
                                    alt="No workshops">
                                <p>{{ __('messages.workshop.no_data') }}.</p>
                            </div>
                        </div>
                    @else
                        <div class="row">
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a href="{{ $bengkels->previousPageUrl() }}"

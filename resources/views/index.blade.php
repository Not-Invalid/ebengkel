...
@section('content')
    ...
    <section class="section bg-white" style="padding-top: 50px; padding-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-primary py-2"><i class='bx bx-calendar me-2'></i>{{ __('messages.home.latest_event') }}
                    </h4>
                    <div class="row">
    ...
    <section class="section bg-white" style="padding-top: 50px; padding-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-primary py-2"><i
                            class='bx bx-building me-2'></i>{{ __('messages.home.latest_workshop') }}</h4>
                    @if ($bengkels->isEmpty())
                        <div class="d-flex justify-content-center pb-5">
                            <div class="text-center">
                                <img src="{{ asset('assets/images/components/empty.png') }}" height="200"
    ...
    <section class="section bg-white" style="padding-top: 50px; padding-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-primary py-2"><i
                            class='bx bxl-dropbox me-2'></i>{{ __('messages.home.new_product') }}</h4>
                    @if ($products->isEmpty())
                        <div class="d-flex justify-content-center pb-5">
                            <div class="text-center">
                                <img src="{{ asset('assets/images/components/empty.png') }}" height="200"
                            ...
                            @foreach ($products as $item)
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <a href="{{ route('Detail-ProductSparePart', ['type' => 'product', 'id' => $item->id_produk]) }}"
                                        class="card-product p-3">
                                        <img src="{{ $item->fotoProduk && file_exists(public_path($item->fotoProduk->file_foto_produk_1))
                                        ...
                                        <div class="card-body text-start">
                                            <p class="workshop-name">
                                                {{ optional($item->bengkel)->nama_bengkel ?? 'No Workshop' }}</p>
                                            <h5 class="card-title">
    ...
    <section class="section bg-white" style="padding-top: 50px; padding-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-primary py-2"><i class='bx bxs-cog me-2'></i>{{ __('messages.home.spare_parts') }}
                    </h4>
                    @if ($products->isEmpty())
                        <div class="d-flex justify-content-center pb-5">
                            <div class="text-center">
                            ...
                            @foreach ($sparepart as $item)
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <a href="{{ route('Detail-ProductSparePart', ['type' => 'sparepart', 'id' => $item->id_spare_part]) }}"
                                        class="card-product p-3">
                                        <img src="{{ $item->fotoSparepart && file_exists(public_path($item->fotoSparepart->file_foto_spare_part_1))

          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="{{ request()->routeIs('pos.transaksi_pesanan.index') ? 'active' : '' }}">
                  <a class="nav-link"
                    href="{{ route('pos.transaksi_pesanan.index', ['id_bengkel' => $bengkel->id_bengkel]) }}">Pesanan</a>
                </li>
              </ul>
            </li>
            <li class="dropdown ">
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                <li class="{{ request()->routeIs('pos.achievement-summary') ? 'active' : '' }}">
                  <a class="nav-link"
                    href="{{ route('pos.achievement-summary', ['id_bengkel' => $bengkel->id_bengkel]) }}">Achievement
                    Summary</a>
                </li>
                <li class="{{ request()->routeIs('pos.monitoring-stock') ? 'active' : '' }}">
                  <a class="nav-link"
                    href="{{ route('pos.monitoring-stock', ['id_bengkel' => $bengkel->id_bengkel]) }}">Stock
                    Monitoring</a>
                </li>
                <li class="{{ request()->routeIs('pos.transaction-history') ? 'active' : '' }}">
                  <a class="nav-link"
                    href="{{ route('pos.transaction-history', ['id_bengkel' => $bengkel->id_bengkel]) }}">Transaction
                    History</a>
                </li>
              </ul>
            </li>

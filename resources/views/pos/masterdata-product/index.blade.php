        ...
        <div class="card-body">
          @if ($products->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.product.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create new
                One</a>
            </div>
          @else
                ...
                <tbody id="product-table-body">
                  ...
                  @foreach ($products as $index => $product)
                    <tr>
                      ...
                      <td>
                        @if ($product->fotoProduk && $product->fotoProduk->file_foto_produk_1)
                          <img src="{{ asset($product->fotoProduk->file_foto_produk_1) }}" alt="Product Image"
                            width="50" height="50" class="rounded">
                        @else
                          <img src="{{ asset('assets/images/components/image.png') }}" alt="Default Product Image"
                            width="50" height="50" class="rounded">
                        @endif
                      </td>

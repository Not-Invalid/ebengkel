            ...
            <div class="card-body">
                <div class="d-flex justify-between">
                    ...
                    <div class="d-flex justify-end mb-4">
                        <a href="{{ route('pos.product.create', ['id_bengkel' => $bengkel->id_bengkel]) }}" class="btn btn-info text-white px-4 py-2 mx-2">Add Product</a>
                    </div>
                </div>
                                ...
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center gap-4">
                                            <a href="{{ route('pos.product.edit', ['id_bengkel' => $bengkel->id_bengkel, 'id_produk' => $product->id_produk]) }}" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('pos.product.destroy', ['id_bengkel' => $bengkel->id_bengkel, 'id_produk' => $product->id_produk]) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')

        ...
        <div class="card-body">
          @if ($pegawai->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.management-user.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create
                new One</a>
            </div>
          @else
            <div class="d-flex justify-between">
              ...
              <div class="d-flex justify-end mb-4">
                <a href="{{ route('pos.management-user.create', $bengkel->id_bengkel) }}"
                  class="btn btn-info text-white px-4 py-2 mx-2">Tambah Pegawai</a>
              </div>
            </div>
                  ...
                  @foreach ($pegawai as $staff)
                    <tr>
                      ...
                      <td class="d-flex justify-content-center align-items-center gap-4">
                        <a href="{{ route('pos.management-user.edit', ['id_bengkel' => $bengkel->id_bengkel, 'id_pegawai' => $staff->id_pegawai]) }}"
                          class="btn btn-sm btn-primary">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <form
                          action="{{ route('pos.management-user.delete', ['id_bengkel' => $bengkel->id_bengkel, 'id_pegawai' => $staff->id_pegawai]) }}"
              ...
              <div class="d-flex">
                <nav aria-label="Page navigation">
                  <ul class="pagination">
                    ...
                    @else
                      <li class="page-item">
                        <a href="{{ $pegawai->previousPageUrl() }}" class="page-link"><i
                    ...
                    @if ($pegawai->hasMorePages())
                      <li class="page-item">
                        <a href="{{ $pegawai->nextPageUrl() }}" class="page-link"><i

        ...
        <div class="card-body">
          @if ($sparepart->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.sparepart.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create new
                One</a>
            </div>
          @else
            <div class="d-flex justify-between">
              ...
              <div class="d-flex justify-end mb-4">
                <a href="{{ route('pos.sparepart.create', ['id_bengkel' => $bengkel->id_bengkel]) }}"
                  class="btn btn-info text-white px-4 py-2 mx-2">Add Spare Part</a>
              </div>
            </div>
                ...
                <tbody id="sparepart-table-body">
                  ...
                  @foreach ($sparepart as $index => $item)
                    <tr>
                      ...
                      <td>
                        @if ($item->fotoSparepart && $item->fotoSparepart->file_foto_spare_part_1)
                          <img src="{{ asset($item->fotoSparepart->file_foto_spare_part_1) }}" alt="Sparepart Image"
                            width="50" height="50" class="rounded">
                        @else
                          <img src="{{ asset('assets/images/components/image.png') }}" alt="Default Sparepart Image"
                            width="50" height="50" class="rounded">
                        @endif
                      </td>

        ...
        <div class="card-body">
          @if ($expenseRecords->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.expense-record.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create
                new One</a>
            </div>
          @else
            ...
            <div class="table-responsive bg-white rounded shadow">
              <table class="table table-bordered table-striped text-center">
                ...
                <tbody id="table-body">
                  @foreach ($expenseRecords as $index => $expense)
                    <tr>
                      <td>{{ $index + 1 }}</td>
                      ...
                      <td class="d-flex gap-3 align-items-center justify-content-center">
                        <a href="{{ route('pos.expense-record.edit', ['id_bengkel' => $bengkel->id_bengkel, 'id_pengeluaran' => $expense->id_pengeluaran]) }}"
                          class="btn btn-sm btn-primary">
                          <i class="fas fa-edit"></i> Edit
                        </a>

                        <form
                          action="{{ route('pos.expense-record.delete', ['id_bengkel' => $bengkel->id_bengkel, 'id_pengeluaran' => $expense->id_pengeluaran]) }}"
              ...
              <div class="d-flex">
                <nav aria-label="Page navigation">
                  <ul class="pagination">
                    ...
                    @else
                      <li class="page-item">
                        <a href="{{ $expenseRecords->previousPageUrl() }}" class="page-link"><i
                    ...
                    @if ($expenseRecords->hasMorePages())
                      <li class="page-item">
                        <a href="{{ $expenseRecords->nextPageUrl() }}" class="page-link"><i

                ...
                <div class="card-body">
                    @if ($service->isEmpty())
                        <div class="empty-state" data-height="400" style="height: 400px;">
                            ...
                            <a href="{{ route('pos.service.create', $bengkel->id_bengkel) }}"
                                class="btn btn-primary mt-4">Create new
                                One</a>
                        </div>
                    @else
                            ...
                            <table class="table table-bordered table-striped text-center">
                                <thead class="bg-light-grey text-white">
                                    <tr>
                                        ...
                                        <th class="text-center">Service Offline</th>
                                        <th class="text-center">Service Online</th>
                                ...
                                <tbody id="service-table-body">
                                    @foreach ($service as $index => $services)
                                        <tr>
                                            ...
                                            <td>{{ $services->jumlah_services_offline }}</td>
                                            <td>{{ $services->jumlah_services_online }}</td>

        ...
        <div class="card-body">
          @if ($service->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.service.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create new
                One</a>
            </div>
          @else
                ...
                <tbody id="service-table-body">
                  ...
                  @foreach ($service as $index => $services)
                    <tr>
                      ...
                      <td>
                        <img
                          src="{{ isset($services->foto_services) ? url($services->foto_services) : asset('assets/images/components/image.png') }}"

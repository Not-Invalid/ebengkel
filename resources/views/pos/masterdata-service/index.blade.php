            ...
            <div class="card-body">
                <div class="d-flex justify-between">
                    ...
                    <div class="d-flex justify-end mb-4">
                        <a href="{{ route('pos.service.create', ['id_bengkel' => $bengkel->id_bengkel]) }}" class="btn btn-info text-white px-4 py-2 mx-2">Add Service</a>
                    </div>
                </div>
                                ...
                                @foreach ($service as $index => $services)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center gap-4">
                                            <a href="{{ route('pos.service.edit', ['id_bengkel' => $bengkel->id_bengkel, 'id_services' => $services->id_services]) }}" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('pos.service.destroy', ['id_bengkel' => $bengkel->id_bengkel, 'id_services' => $services->id_services]) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="d-flex">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a href="{{ $service->previousPageUrl() }}" class="page-link"><i class="fa-solid fa-chevron-left"></i></a>
                                    </li>
                                @endif
                                ...
                                @if ($service->hasMorePages())
                                    <li class="page-item">
                                        <a href="{{ $service->nextPageUrl() }}" class="page-link"><i class="fa-solid fa-chevron-right"></i></a>
                                    </li>
                                @else
                                    <li class="page-item disabled">

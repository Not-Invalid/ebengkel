    ...
    <div class="card">
        ...
        <div class="card-body">
            <form
                ...
                <div class="form-group">
                    <label for="jumlah_services_offline">Jumlah Services Offline <small>(Per hari)</small> <span
                            class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="jumlah_services_offline"
                        value="{{ old('jumlah_services_offline', $service->jumlah_services_offline) }}" required>
                </div>
                <div class="form-group">
                    <label for="jumlah_services_online">Jumlah Services Online <small>(Per hari)</small> <span
                            class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="jumlah_services_online"
                        value="{{ old('jumlah_services_online', $service->jumlah_services_online) }}" required>
                </div>

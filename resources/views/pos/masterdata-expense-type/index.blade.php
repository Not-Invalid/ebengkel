        ...
        <div class="card-body">
          @if ($jenisPengeluaran->isEmpty())
            <div class="empty-state" data-height="400" style="height: 400px;">
              ...
              <a href="{{ route('pos.expense-type.create', $bengkel->id_bengkel) }}" class="btn btn-primary mt-4">Create
                new One</a>
            </div>
          @else
            <div class="d-flex justify-between">
              ...
              <div class="d-flex justify-end mb-4">
                <a href="{{ route('pos.expense-type.create', ['id_bengkel' => $bengkel->id_bengkel]) }}"
                  class="btn btn-info text-white px-4 py-2 mx-2">Add Expense Type</a>
              </div>
            </div>
                  ...
                  @foreach ($jenisPengeluaran as $index => $item)
                    <tr>
                      ...
                      <td class="d-flex gap-3 align-items-center justify-content-center">
                        <a href="{{ route('pos.expense-type.edit', ['id_bengkel' => $bengkel->id_bengkel, 'id_jenis_pengeluaran' => $item->id_jenis_pengeluaran]) }}"
                          class="btn btn-sm btn-primary">
                          <i class="fas fa-edit"></i> Edit
                        </a>

                        <form
                          action="{{ route('pos.expense-type.delete', ['id_bengkel' => $bengkel->id_bengkel, 'id_jenis_pengeluaran' => $item->id_jenis_pengeluaran]) }}"
              ...
              <div class="d-flex">
                <nav aria-label="Page navigation">
                  <ul class="pagination">
                    ...
                    @else
                      <li class="page-item">
                        <a href="{{ $jenisPengeluaran->previousPageUrl() }}" class="page-link"><i
                    ...
                    @if ($jenisPengeluaran->hasMorePages())
                      <li class="page-item">
                        <a href="{{ $jenisPengeluaran->nextPageUrl() }}" class="page-link"><i

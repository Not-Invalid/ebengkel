                ...
                @foreach($category as $data)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('blog-category-edit', $data->id) }}" class="btn btn-custom-3 my-2" title="Edit" category-bs-toggle="tooltip">
                                <i class="fas fa-edit text-primary"></i>
                            </a>

                            <form action="{{ route('blog-category-delete', $data->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')

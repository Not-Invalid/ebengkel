 ...
 @section('content')
             ...
             <div class="row">
                 <div class="col-12">
                     <div class="d-flex align-items-center mt-5 ms-3">
                         ...
                         <span class="fw-bold">{{ __('messages-superadmin.sidebar.info_workshop.open_workshop') }} : </span>
                         <span class="ms-1">
                     ...
                     <div class="d-flex align-items-center mt-3 ms-3">
                         <i class="fa-regular fa-calendar-days me-2"></i>
                         <span class="fw-bold">{{ __('messages-superadmin.sidebar.info_workshop.location') }} : </span>
                 ...
                 <div class="container">
                     <div class="row g-4 justify-content-center align-items-center">
                         <div class="col-12 col-md-3 text-center total">
                             <h2 class="text-black mb-2 counter" data-target="{{ $totalProducts }}">{{ $totalProducts }}
                             </h2>
                             <div class="d-flex align-items-center justify-content-center">
                                 <i class="fas fa-box-open fa-2x fs-5 text-black me-2"></i>
                                 <p class="text-black mb-0">
                                     {{ __('messages-superadmin.sidebar.info_workshop.count_product') }}</p>
                             </div>
                         </div>
                         <div class="col-12 col-md-3 text-center total">
                             <h2 class="text-black mb-2 counter" data-target="{{ $totalSpareParts }}">
                                 {{ $totalSpareParts }}</h2>
                             <div class="d-flex align-items-center justify-content-center">
                                 <i class="fas fa-cogs fa-2x fs-5 text-black me-2"></i>
                                 <p class="text-black mb-0">
                                     {{ __('messages-superadmin.sidebar.info_workshop.count_sparepart') }}</p>
                             </div>
                         </div>
                         <div class="col-12 col-md-3 text-center total">
                             <h2 class="text-black mb-2 counter" data-target="{{ $totalServices }}">{{ $totalServices }}
                             </h2>
                             <div class="d-flex align-items-center justify-content-center">
                                 <i class="fas fa-cog fa-2x fs-5 text-black me-2"></i>
                                 <p class="text-black mb-0">
                                     {{ __('messages-superadmin.sidebar.info_workshop.count_service') }}</p>
                             </div>
                         </div>
                         <div class="col-12 col-md-3 text-center total">
                             ...
                             <div class="d-flex align-items-center justify-content-center">
                                 ...
                                 <p class="text-black mb-0">{{ __('messages-superadmin.sidebar.info_workshop.rating') }}
                                 </p>
                             </div>
                         </div>
                     </div>
         ...
         <div class="w-100 shadow bg-white rounded" style="padding: 1rem">
             ...
             <div class="filter-section mb-3">
                 <select id="filterSelect" class="form-select" aria-label="Filter Products">
                     <option value="all">{{ __('messages-superadmin.sidebar.info_workshop.all') }}</option>
                     <option value="product">{{ __('messages-superadmin.sidebar.info_workshop.product') }}</option>
                     <option value="sparepart">{{ __('messages-superadmin.sidebar.info_workshop.sparepart') }}</option>
                     <option value="service">{{ __('messages-superadmin.sidebar.info_workshop.service') }}</option>
                 </select>
             </div>
                         ...
                         <a href="" class="card-event">
                             <div class="product-card shadow">
                                 ...
                                 <div class="product-info text-start">
                                     ...
                                     <div class="d-flex justify-content-start mt-5 align-items-center">
                                         <span class="price">Rp
                                             {{ number_format($sparePart->harga_spare_part, 0, ',', '.') }}</span>
                                     </div>
                                 </div>
                             </div>
                         </a>
                         ...
                         <a href="" class="card-event">
                             <div class="product-card shadow">
                                 ...
                                 <div class="product-info text-start">
                                     ...
                                     <div class="d-flex justify-content-start mt-5 align-items-center">
                                         <span class="price">Rp
                                             {{ number_format($service->harga_services, 0, ',', '.') }}</span>
                                     </div>
                                 </div>
                             </div>
                         </a>
     ...
     <script>
         ...
         var myline = new Chart(line, {
             ...
             data: {
                 labels: [
                     " {{ __('messages-superadmin.sidebar.month.january') }}",
                     "{{ __('messages-superadmin.sidebar.month.february') }}",
                     "{{ __('messages-superadmin.sidebar.month.march') }}",
                     "{{ __('messages-superadmin.sidebar.month.april') }}",
                     "{{ __('messages-superadmin.sidebar.month.may') }}",
                     "{{ __('messages-superadmin.sidebar.month.june') }}",
                     "{{ __('messages-superadmin.sidebar.month.july') }}",
                     "{{ __('messages-superadmin.sidebar.month.august') }}",
                     "{{ __('messages-superadmin.sidebar.month.september') }}",
                     "{{ __('messages-superadmin.sidebar.month.october') }}",
                     "{{ __('messages-superadmin.sidebar.month.november') }}",
                     "{{ __('messages-superadmin.sidebar.month.december') }}"
                 ],
                 datasets: [{
                         label: "{{ __('messages-superadmin.sidebar.info_workshop.sold_product') }}",
                         data: [120, 150, 170, 130, 200, 180, 210, 190, 230, 250, 220,
                             240
                     ...
                     {
                         label: "{{ __('messages-superadmin.sidebar.info_workshop.sold_service') }}",
                         data: [100, 130, 150, 120, 170, 160, 200, 180, 210, 220, 190,
                             230
                         ],

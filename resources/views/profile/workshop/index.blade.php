                            ...
                            <div class="card-body text-start">
                                <div class="d-flex align-items-center location-map my-2">
                                    ...
                                    <p class="location m-0">
                                        {{ \Illuminate\Support\Str::limit($bengkel->alamat_bengkel, 18) }}</p>
                                </div>
                                <h5 class="card-title">
                                ...
                                <div class="footer-card d-flex justify-content-start gap-3 mt-3">
                                    ...
                                    <a href="{{ route('profile.workshop.detail', ['id_bengkel' => $bengkel->id_bengkel]) }}"
                                        class="btn btn-link" title="detail">
                                        <i class='bx bx-info-circle' style="font-size: 1.3rem;"></i>
                                    </a>
                                    <form
                                        action="{{ route('profile.workshop.destroy', ['id_bengkel' => $bengkel->id_bengkel]) }}"
                                        method="POST"

...
@section('content')
    <div class="w-100 shadow bg-white rounded" style="padding: 1rem">
        <h4>{{ __('messages.profile.workshop.edit_workshop') }}</h4>
            ...
            <div class="form-group mb-3">
                <div class="did-floating-label-content">
                    <select name="kota" id="kota" class="did-floating-select">
                        <option value="" selected disabled hidden>{{ __('messages.profile.workshop.fields.city') }}
                        </option>
                        <!-- Options will be populated by JavaScript -->
                    </select>
                ...
                <div class="col-md-6 py-2">
                    <div class="did-floating-label-content">
                        <select class="did-floating-select" name="open_day" id="open_day" required
                            ...
                            <option value="Monday"
                                {{ old('open_day', $bengkel->open_day) == 'Monday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Monday') }}
                            </option>
                            <option value="Tuesday"
                                {{ old('open_day', $bengkel->open_day) == 'Tuesday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Tuesday') }}
                            </option>
                            <option value="Wednesday"
                                {{ old('open_day', $bengkel->open_day) == 'Wednesday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Wednesday') }}</option>
                            <option value="Thursday"
                                {{ old('open_day', $bengkel->open_day) == 'Thursday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Thursday') }}
                            </option>
                            <option value="Friday"
                                {{ old('open_day', $bengkel->open_day) == 'Friday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Friday') }}
                            </option>
                            <option value="Saturday"
                                {{ old('open_day', $bengkel->open_day) == 'Saturday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Saturday') }}
                            </option>
                            <option value="Sunday"
                                {{ old('open_day', $bengkel->open_day) == 'Sunday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Sunday') }}
                            </option>
                            <option value="Every Day"
                                {{ old('open_day', $bengkel->open_day) == 'Every Day' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Every Day') }}</option>
                        </select>
                ...
                <div class="col-md-6 py-2">
                    <div class="did-floating-label-content">
                        <select class="did-floating-select" name="close_day" id="close_day" required
                            ...
                            <option value="" selected disabled hidden></option>
                            <option value="Monday"
                                {{ old('close_day', $bengkel->close_day) == 'Monday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Monday') }}
                            </option>
                            <option value="Tuesday"
                            ...
                            <option value="Thursday"
                                ...
                                {{ __('messages.profile.workshop.fields.day.Thursday') }}</option>
                            <option value="Friday"
                                {{ old('close_day', $bengkel->close_day) == 'Friday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Friday') }}
                            </option>
                            <option value="Saturday"
                                {{ old('close_day', $bengkel->close_day) == 'Saturday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Saturday') }}</option>
                            <option value="Sunday"
                                {{ old('close_day', $bengkel->close_day) == 'Sunday' ? 'selected' : '' }}>
                                {{ __('messages.profile.workshop.fields.day.Sunday') }}
                            </option>
                        </select>
            ...
            <div class="row mb-3">
                <div class="col-md-6 py-2">
                    <div class="did-floating-label-content">
                        ...
                        <label class="did-floating-label">{{ __('messages.profile.workshop.fields.open_hour') }}</label>
                    </div>
                </div>
                <div class="col-md-6 py-2">
                    <div class="did-floating-label-content">
                        ...
                        <label class="did-floating-label">{{ __('messages.profile.workshop.fields.close_hour') }}</label>
                    </div>
                </div>
            </div>
                ...
                @foreach ($bankAccounts as $index => $bankAccount)
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <div class="did-floating-label-content">
                                <input class="did-floating-input" type="text" placeholder=" "
                                    name="rekening_bank[{{ $index }}][nama_bank]"
                                    value="{{ old('rekening_bank.' . $index . '.nama_bank', $bankAccount['nama_bank']) }}" />
                                <label
                                    class="did-floating-label">{{ __('messages.profile.workshop.fields.bank_name') }}<span
                                        class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="row mb-3">
                <div class="col text-left">
                    <button type="button" class="btn btn-custom-3" id="add-bank-account"
                        style="display: {{ in_array('Manual Transfer', old('payment', $paymentMethods)) ? 'block' : 'none' }};">{{ __('messages.profile.workshop.labels.add_bank_account') }}</button>
                </div>
            </div>

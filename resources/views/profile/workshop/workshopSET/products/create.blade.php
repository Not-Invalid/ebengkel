    ...
    <form action="{{ route('profile.workshop.createProduct.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input class="did-floating-input" type="text" placeholder=" " id="nama_produk" name="nama_produk" required />
          <label class="did-floating-label">Product Name</label>
        </div>
      </div>
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input class="did-floating-input" type="text" placeholder=" " id="merk_produk" name="merk_produk" required />
      ...
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input class="did-floating-input" type="number" placeholder=" " id="stok_produk" name="stok_produk" required />
          <label class="did-floating-label">Product Stock</label>
        </div>
      </div>
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input class="did-floating-input" type="text" placeholder=" " id="harga_produk" name="harga_produk" required

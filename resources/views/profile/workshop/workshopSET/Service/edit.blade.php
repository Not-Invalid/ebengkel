...
@section('content')
  <div class="w-100 shadow bg-white rounded" style="padding: 1rem">
    <h4>Edit Service</h4>
    <form action="{{ route('profile.workshop.workshopSET.service.update', $service->id_services) }}" method="POST"
      ...
      <div class="form-group mb-4">
        <div class="upload-box">
          ...
          <div class="preview-container d-flex justify-content-center">
            <img id="servicePreview"
              src="{{ $service->foto_services ? asset($service->foto_services) : asset('assets/images/components/image.png') }}"
              alt="Service Photo Preview" class="image-preview" style="display: block; width: 200px; margin-top: 10px;">
          </div>
        </div>
      </div>
      ...
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input type="hidden" name="id_bengkel" value="{{ $service->id_bengkel }}">
      ...
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <textarea class="did-floating-input form-control" name="keterangan_services" placeholder=" " rows="4" required
            style="height: 100px; resize: none;">{{ old('keterangan_services', $service->keterangan_services) }}</textarea>
      ...
      <div class="form-group mb-3">
        <div class="did-floating-label-content">
          <input class="did-floating-input" type="text" name="harga_services" placeholder=""
            value="{{ old('harga_services', $service->harga_services) }}" required pattern="[0-9]*"

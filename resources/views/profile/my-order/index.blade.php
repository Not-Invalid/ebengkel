                                ...
                                @else
                                    @foreach ($filteredOrders as $order)
                                        <a href="{{ route('my-order.detail', ['order_id' => $order->order_id]) }}"
                                            ...
                                            <div class="cart-item d-flex flex-column flex-sm-row align-items-center justify-content-between mb-3 p-3 border rounded shadow-sm"
                                                data-id="{{ $order->order_id }}"
                                                data-stock="{{ $order->orderItems->sum('qty') }}"
